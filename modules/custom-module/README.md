...
1. Copy the folder `examples/module-templates/custom-module` to `modules/custom-module`
2. Open a terminal in the folder `modules/custom-module` and type `yarn && yarn build`
...
```js
{
  ...
  "modules": [
    ...
    {
      "location": "MODULES_ROOT/custom-module",
      "enabled": true
    },
}
```
